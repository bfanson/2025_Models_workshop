...
$$
\text{logit}(p_i) = \beta_0 + \beta_1 * \text{sunny}_i + \beta_2 * \text{temperature}_i + \beta_3 * \text{temperature}_i*\text{sunny}_i +
\beta_4 * \text{area}_i
$$
...
$$log(\lambda) = log(\frac{n}{\text{effort}}) = \beta_0 + \beta_1 Discharge$$
